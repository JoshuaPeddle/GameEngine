...
| ID | Sev | Finding | Location | Confirmed | Status |
|---|---|---|---|---|---|
| GE-91 | S1 | Pointer releases synthesize keys without scene opt-in; Avalonia hover requires a pressed pointer | GameView / MainView | code + RPG regression history | open |
